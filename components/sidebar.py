...
layout = dbc.Container([
    ...
    dbc.Container([
        dbc.Row([
            dbc.Col([
                html.H1("Luzo", style={'color': 'pink'})  # , 'font-size': 'width / 1.2'})
            ])
        ]),
        dbc.Row([
            dbc.Col([
                html.H3("Neto", style={'color': 'white'})
            ]),
        ]),
    ...
    dbc.Row([
        dbc.Col([
            dbc.Nav([
                ...
                html.Br(),
                dbc.NavItem(
                    dbc.NavLink([html.I(className='fa fa-plus-circle dbc'), "\tPROCESSOS"], id='processo_button',
                                active=True, style={'text-align': 'left'})),
                html.Br(),
                dbc.NavItem(dbc.NavLink([html.I(className='fa fa-user-plus dbc'), "\tPESSOAS"], id='lawyers_button',
                                        active=True, style={'text-align': 'left'})),
