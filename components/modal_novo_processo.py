        ...
        dbc.Row([
            dbc.Col([
                ...
                dcc.Dropdown(id='acao', clearable=False, className='dbc',
                             options=['Alimentos', 'Busca e Apreensão', 'Cautelar Inominada', 'Consignação',
        ...
        dbc.Row([
            dbc.Col([
                dcc.Dropdown(id='input_local_arquivo', clearable=False, className='dbc',
                             placeholder="Local de Arquivo/Local Físico",
                             options=['Armário Principal', 'Armário 17 gaveta 2', 'Armário 5 gaveta 1', 'Arquivo 01',
                                      'Arquivo 02']),
            ], sm=12, md=5, style={'padding': '15px'}),
            dbc.Col([
                dbc.Input(id="input_no_processo", placeholder="Insira o número do Processo", type="number",
                          disabled=False)
